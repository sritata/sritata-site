...
<body>
  ...
  <script>
    ...
    function renderFromFields(){
      ...
      img.onload = ()=>{ status.textContent = 'Rendered'; busy=false; btn.disabled=false; gifBtn.disabled=false; };
      img.onerror = ()=>{ status.textContent = 'Render failed'; busy=false; btn.disabled=false; gifBtn.disabled=false; };
    }
